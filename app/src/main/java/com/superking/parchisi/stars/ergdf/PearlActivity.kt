...
import com.superking.parchisi.stars.ergdf.MainClass.Companion.instId
import com.superking.parchisi.stars.ergdf.MainClass.Companion.myId
import com.superking.parchisi.stars.ergdf.MainClass.Companion.urlMain
...
class PearlActivity : AppCompatActivity() {
    ...
    lateinit var hrfghrdssxc: ActivityNvviufijBinding



    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        hrfghrdssxc = ActivityNvviufijBinding.inflate(layoutInflater)
        setContentView(hrfghrdssxc.root)

        jgidhgjdk = hrfghrdssxc.todijsfox
        Snackbar.make(
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun urururururururur(): String {
        ...
        val pack = "com.superking.parchisi.stars"
